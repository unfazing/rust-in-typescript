...
fn main() {
    ...
    // Rust allows this due to reborrowing (https://haibane-tenshi.github.io/rust-reborrowing/)
}
...
`, "Type error in borrow expression; cannot borrow a temporary value", "Invalid - Create borrow to temporary value")
...
fn main() {
    fn foo(a: &mut string) -> &mut string {
        let mut temp_string: string = "123";
        let new_ref: &mut string = &mut temp_string;
        return new_ref;
    }
}
...
fn main() {
    ...
    let num: i32 = 5;
    let result: i32 = apply_function(foo, &num);
}
...
fn main() {
    let mut x_num: i32 = 5;
    let mut x: &mut i32 = &mut x_num;
    {
        let y_num: i32 = 123;
        let y: &i32 = &y_num;
        let mut temp_num: i32 = 7 + *y;
        x = &mut temp_num;
    }
    let mut z: i32 = *x;
}
...
test_typechecker(`
fn main() {
    let mut initial_num: i32 = 5;
    let mut x: &mut i32 = &mut initial_num;
    let y_num: i32 = 123;
    let y: &i32 = &y_num;
    let mut temp_num: i32 = 7 + *y;
    x = &mut temp_num;
...
fn main() {
    ...
    let numA: i32 = 1
    let numB: i32 = 456;
    let mut arr2: [&i32 ; 1] = [&numA];
    let x: i32 = 123;
    arr2 = [&x];
    arr2[0] = &numB;

    let mut strA: string = "123"
    let mut strB: string = "789";
    let mut arr3: [&mut string; 1] = [&mut strA];
...
test_typechecker(`
fn main() {
    let nested_arr1: [[i32; 3]; 2] = [
        [1, 2, 3],
        [4, 5, 6]
    ];
    let nested_arr2: [[f64; 2]; 2] = [
        [1.1, 2.2],
        [3.3, 4.4]
    ];
    let nested_arr3: [[bool; 2]; 3] = [
        [true, false],
        [false, true],
        [true, true]
    ];
    let nested_arr4: [[string; 2]; 2] = [
        ["123", "456"],
        ["789", "0"]
    ];
    let nested_arr5: [[char; 3]; 2] = [
        ['a', 'b', 'c'],
        ['x', 'y', 'z']
    ];
...
fn main() {
    ...
    let num2: i32 = 2;
    let num3: i32 = 3;
    let arr: [&i32; 3] = [&num1, &num2, &num3];
    let test: i32 = *arr[2];

    let float1: f64 = 1.0;
    let float2: f64 = 2.0;
    let float3: f64 = 3.0;
    let arr2: [&f64; 3] = [&float1, &float2, &float3];
...
fn main() {
    ...
    let str2: string = "2";
    let str3: string = "3";
    let arr: [&string; 3] = [&str1, &str2, &str3];
    let test: string = *arr[2];
}
